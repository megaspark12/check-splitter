...
class TestBillCalculatorItemSplitting:
    ...
    def test_single_item_single_participant(self):
        ...
        assignments = [_Assignment(item_id="item1", participant_id="p1", share_count=1)]
...
class TestBillCalculatorTipCalculation:
    ...
    def test_tip_percentage(self):
        ...
        tip = calculator.calculate_tip(
            subtotal=Decimal("50.00"), tip_percentage=Decimal("20.00"), tip_amount=None
        )
    ...
    def test_no_tip(self):
        ...
        calculator = BillCalculator()
        tip = calculator.calculate_tip(
            subtotal=Decimal("50.00"), tip_percentage=None, tip_amount=None
        )
    ...
    def test_zero_tip_percentage(self):
        ...
        calculator = BillCalculator()
        tip = calculator.calculate_tip(
            subtotal=Decimal("50.00"), tip_percentage=Decimal("0.00"), tip_amount=None
        )
    ...
    def test_tip_on_small_amount(self):
        ...
        calculator = BillCalculator()
        tip = calculator.calculate_tip(
            subtotal=Decimal("7.50"), tip_percentage=Decimal("15.00"), tip_amount=None
        )
...
class TestBillCalculatorEdgeCases:
    ...
    def test_empty_items_list(self):
        ...
        result = calculator.calculate_full_split(
            items=[], participants=[_Participant(id="p1", name="Alice")], assignments=[]
        )
